...
ggplot() + 
  theme_bw() +
  facet_grid(Barrel~LandSet, labeller = label_both) +
  # geom_line(aes(x = x, y = sig/5 - line_id + 3.5, color = factor(line_id)), data = res_align_plotable) + 
  geom_line(aes(x = x, y = med/4 + 6.5), color = 'grey60', data = res_align_plotable_med) + 
